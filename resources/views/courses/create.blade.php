        ...
        <form id="createCourseForm" method="POST" action="{{ route('courses.store') }}">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        <label for="code" style="display: block; font-weight: 600; margin-bottom: 8px; color: #555;">
                            Código del Curso *
                        </label>
                        <input type="text" 
                               id="code" 
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        <label for="price" style="display: block; font-weight: 600; margin-bottom: 8px; color: #555;">
                            Precio *
                        </label>
                        <input type="number" 
                               id="price" 
                            ...
                            @foreach($availableCourses as $availableCourse)
                                <label style="display: flex; align-items: center; gap: 10px; padding: 12px; border: 1px solid #ddd; border-radius: 8px; cursor: pointer; transition: all 0.2s ease;">
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size: 12px; color: #666;">{{ $availableCourse->code }}</div>
                                    </div>
                                </label>
                            @endforeach
                        </div>
...
document.getElementById('title').addEventListener('input', function() {
    ...
    if (!codeField.value) {
        const title = this.value.toUpperCase()
            .replace(/[^A-Z0-9\s]/g, '')
            .split(' ')
